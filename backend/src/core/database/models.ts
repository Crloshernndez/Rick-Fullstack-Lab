...
export { Favorite } from "../../modules/character-catalog/infrastructure/persistence/sequelize/models/Favorite.model";
export { Comment } from "../../modules/character-catalog/infrastructure/persistence/sequelize/models/Comment.model";
